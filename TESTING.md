...
|                                         | View (/feed) without following users | Page loads displaying a message suggesting to follow other profiles                                  | ✅ PASS      |                  |
|                                         | View (/feed) when following users | Page loads with posts from profiles they are following                                                 | ✅ PASS      |                  |
...
Bookmark posts                                               | ✅ PASS      |                  |
|                                         | View Bookmark page with liked posts            | Page loads with posts they have Bookmarked                                                                   | ✅ PASS      |                  |
...
| **Bookmarks**                               | Bookmark count increases                        | Bookmark count increases and Bookmark button changes                                                            | ✅ PASS      |                  |
